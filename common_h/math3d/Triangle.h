...
mathinline Triangle::Triangle(const Triangle & triangle)
{
	p1 = triangle.p1;
	p2 = triangle.p2;
	p3 = triangle.p3;
...
mathinline Triangle & Triangle::operator = (const Triangle & triangle)
{
	p1 = triangle.p1;
	p2 = triangle.p2;
	p3 = triangle.p3;
...
mathinline Triangle::CoIntersectionResult Triangle::IsCoplanarIntersection(const Triangle & t, float intsEps) const
{
	...
	double cs = n | nt;
	static const double cosMin = cos(0.5f*3.141592654f/180.0f);
	...
	if(count < 3) return cir_coplanar;
