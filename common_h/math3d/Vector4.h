...
public:
	...
	Vector4 mathcall operator - () const;

	///Присвоить
	Vector4 & mathcall operator = (float f);
	///Присвоить
	Vector4 & mathcall operator = (double d);
	///Присвоить
	Vector4 & mathcall operator = (const Vector & v);
	///Присвоить
	Vector4 & mathcall operator = (const Vector4 & v);
...
///Найти квадрат длинны вектора
mathinline float mathcall Vector4::operator ~ () const
{
	return x*x + y*y + z*z + w*w;
}

///Получить отрицательный вектор
mathinline Vector4 mathcall Vector4::operator - () const
{
	Vector4 v(*this);
	v.x = -v.x;
	v.y = -v.y;
...
///Присвоить
mathinline Vector4 & mathcall Vector4::operator = (float f)
{
	v = f;
	w = 1.0f;
	return *this;
...
///Присвоить
mathinline Vector4 & mathcall Vector4::operator = (double d)
{
	v = d;
	w = 1.0f;
	return *this;
...
///Присвоить
mathinline Vector4 & mathcall Vector4::operator = (const Vector & v)
{
	this->v = v;
	w = 1.0f;
	return *this;
...
///Присвоить
mathinline Vector4 & mathcall Vector4::operator = (const Vector4 & v)
{
	x = v.x;
	y = v.y;
	z = v.z;
...
//Нормализовать w компаненту
mathinline void mathcall Vector4::Normalize()
{
	double k = 1.0/w;
	x = float(k*x);
	y = float(k*y);
