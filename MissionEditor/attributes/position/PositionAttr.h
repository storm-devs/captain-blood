#ifndef POSITION_ATTRIBUE
#define POSITION_ATTRIBUE

#include "..\baseattr.h"
#include "PositionForm.h"


class PositionAttribute : public BaseAttribute
{
	Vector SavedValue;
...
public:
	...
	PositionAttribute & operator = (const PositionAttribute & source);
	PositionAttribute & operator = (const IMOParams::Position& source);
