...
void TransformGizmo::DrawMoveGizmo ()
{
	...
	pRS->DrawVector(mFrom, vXAxis, AxisColors[X_AXIS_INDEX], "EditorLineNoZ");
	pRS->DrawVector(mFrom, vYAxis, AxisColors[Y_AXIS_INDEX], "EditorLineNoZ");
	pRS->DrawVector(mFrom, vZAxis, AxisColors[Z_AXIS_INDEX], "EditorLineNoZ");
