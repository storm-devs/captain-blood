...
float4 gmxShowGloss(GMX_PS_IN pnt) : COLOR
{
...
Technique(gmx_ShowGloss, GMX_VS_IN_STATIC)
{
	pass P0
	{
		...
		PixelShader = compile ps_2_0 gmxShowGloss();
	}
}

Technique(gmx_ShowGloss_anim_1, GMX_VS_IN_ANIM)
{
	pass P0 
	{
		AlphaBlendEnable = false;
...
Technique(gmx_ShowGloss_anim_2, GMX_VS_IN_ANIM)
{
	pass P0
	{
		AlphaBlendEnable = false;
...
Technique(gmx_ShowGloss_anim_3, GMX_VS_IN_ANIM)
{
	pass P0
	{
		AlphaBlendEnable = false;
