...
/*float4 PSSM_PROJ_PShader_Cast(PSSM_PS_INPUT In) : COLOR
{
...
Technique(PSSM_PROJ_Cast, GMX_VS_IN_STATIC)
{
	pass P0
	{
		//CullMode = none;
		...
		PixelShader = compile ps_2_0 PSSM_PROJ_PShader_Cast();
	}
}

// ANIM 1
Technique(PSSM_PROJ_Cast_anim_1, GMX_VS_IN_ANIM)
{
	pass P0
	{
		//CullMode = none;
...
// ANIM 2
Technique(PSSM_PROJ_Cast_anim_2, GMX_VS_IN_ANIM)
{
	pass P0
	{
		//CullMode = none;
...
// ANIM 3
Technique(PSSM_PROJ_Cast_anim_3, GMX_VS_IN_ANIM)
{
	pass P0
	{
		//CullMode = none;
